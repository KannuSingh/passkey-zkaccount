...
export declare namespace PasskeyZkAccount {
  ...
  export type ZkSessionStructOutput = [
    sessionCommitment: bigint,
    validUntil: bigint,
    validAfter: bigint
  ] & { sessionCommitment: bigint; validUntil: bigint; validAfter: bigint };
  ...
  export type SessionSignatureProofStructOutput = [
    ...
    values: bigint[]
  ] & { application: string; nullifierHash: bigint; values: bigint[] };
}

export interface PasskeyZkAccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_signer"
      | "addDeposit"
  ...
  encodeFunctionData(
    functionFragment: "getSessionForApplication",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PasskeyZkAccount.SessionSignatureProofStruct]
  ): string;
  encodeFunctionData(
    functionFragment: "setSessionForApplication",
    values: [AddressLike, PasskeyZkAccount.ZkSessionStruct]
  ): string;
  encodeFunctionData(
...
export interface PasskeyZkAccount extends BaseContract {
  connect(runner?: ContractRunner | null): PasskeyZkAccount;
  waitForDeployment(): Promise<this>;

  interface: PasskeyZkAccountInterface;
  ...
  getSessionForApplication: TypedContractMethod<
    [applicationContractAddress: AddressLike],
    [PasskeyZkAccount.ZkSessionStructOutput],
    "view"
  >;
  ...
  sessionSignatureProofStruct: TypedContractMethod<
    [sig: PasskeyZkAccount.SessionSignatureProofStruct],
    [void],
    "nonpayable"
  >;

  setSessionForApplication: TypedContractMethod<
    [
      applicationContractAddress: AddressLike,
      session: PasskeyZkAccount.ZkSessionStruct
    ],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getSessionForApplication"
  ): TypedContractMethod<
    [applicationContractAddress: AddressLike],
    [PasskeyZkAccount.ZkSessionStructOutput],
    "view"
  ...
  >;
  getFunction(
    nameOrSignature: "setSessionForApplication"
  ): TypedContractMethod<
    [
      applicationContractAddress: AddressLike,
      session: PasskeyZkAccount.ZkSessionStruct
